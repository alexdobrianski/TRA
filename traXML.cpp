...
long double __AH_[2][7] = {   120,         120,         120,          120,         120,         120,         120,
                              500,         500,         500,          500,         500,         500,         500};

long double __LH_[2][7] = {   120,         120,         120,          120,        120,         120,         120,  
                              640,         660,         740,          800,        860,         900,         900};

long double __BH_[2][7] = {   120,         120,         120,          120,         120,         120,         120,
                              600,         660,         760,          800,         860,         920,         980};

    long double __CH_[2][7] = {            120,         120,         120,          120,         120,         120,         120,  
                                         640,         700,         760,          820,         860,         920,         980};

    long double __CO_[2][5][7] = {    -1.04825,    -0.93106,   -0.820867,    -0.744047,   -0.722471,   -0.687482,   -0.739984,
    ...
    long double __NO_[2][3][7] = {      2.058,       2.058,       2.058,        2.058,       2.058,       2.058,        2.058,
    ...
    long double __FEO_[2][1][7] = {     0.5411,     0.5515,      0.5585,       0.5585,      0.5585,      0.5585,       0.5585,
                                       0.5411,     0.5515,      0.5585,       0.5585,      0.5585,      0.5585,       0.5585};

    long double __DH_[2][7] = {            120,         120,         120,          120,         120,         120,         120,  
                                         1500,        1500,        1500,         1500,        1500,        1500,        1500};

    long double __DO_[2][5][7] =  { -0.351899,   -0.047813,     0.20981,     0.265174,     0.23047,    0.170074,     0.088141,
   ...
   long double __EH_[2][7] = {            120,         120,         120,          120,         120,         120,         120,  
                                         600,         700,         780,          800,         800,         900,         960};

    long double __EO_[2][9][7] =  {  -0.731596,    -0.752175,    -0.570476,     -0.949573,    -0.967598,     -1.02278,-   0.757903,
   ...
   long double __ET_[2][4][7] =  {     -0.2061,   -0.169279,      -0.14637,-      0.13121,-     0.12067,    -0.113399,-     0.104243,
...
void init_tra_XML(void)
{
    ...
    memcpy(__AH, __AH_, sizeof(__AH));
    memcpy(__LH, __LH_, sizeof(__LH));
    memcpy(__BH, __BH_, sizeof(__BH));

    memcpy(__AO, __AO_, sizeof(__AO));
    memcpy(__L0, __L0_, sizeof(__L0));
    memcpy(__BO, __BO_, sizeof(__BO));

    memcpy(__CH, __CH_, sizeof(__CH));
    memcpy(__CO, __CO_, sizeof(__CO));
    memcpy(__NO, __NO_, sizeof(__NO));
    memcpy(__FEO, __FEO_, sizeof(__FEO));
    memcpy(__DH, __DH_, sizeof(__DH));
    memcpy(__DO, __DO_, sizeof(__DO));
    memcpy(__EH, __EH_, sizeof(__EH));
    memcpy(__EO, __EO_, sizeof(__EO));
    memcpy(__ET, __ET_, sizeof(__ET));
    ...
    dStartGreenwichA = 0.0;
    strcpy(UseSatData,"SGP4");

    Targetlongitude = -15.0; // dolgota
    Targetlatitude = -2.0; // shirota
